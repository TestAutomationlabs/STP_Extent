...
public class PostButtonTest extends TestBase {
	 ...
	 /* public void verifySTPToolIcon() throws Exception
	  {
		  ...
		  List<WebElement>stpnews_list=driver.findElements(By.xpath("//div[@class='news-title fs-15p font-weight-bold break-word']"));
	...
	@Test(priority = 6)
		...
		public void verifySTPToolIcon() throws Exception {
			// *[@id="root"]/div/div[2]/div[2]/div[1]/div/div[3]/div/div[1]/span/div[1]
		//*[@id="root"]/div/div[2]/div[2]/div[1]/div/div[3]/div/div
		  ...
		  for(int i=1; i<rowcount; i++)
		  {
				...
				stptooldata_valdn = homepage.EnteredSTPToolData.getText();
				System.out.println("stptooldata_valdn" +stptooldata_valdn);
				//if (name.contains(post.titledata_valdn) && name.contains(stptooldata_valdn)) {
